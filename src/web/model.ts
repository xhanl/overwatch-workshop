...
type 常量图标类型 = {
  ...
  补全?: {
    深色: vscode.CompletionItem;
    浅色: vscode.CompletionItem;
  };
};
...
type 规则类型 = {
  事件: 规则事件类型;
  条件: Record<string, 规则条件类型>;
  动作: Record<string, 规则动作类型>;
};
...
type 扩展类型 = Record<string, { 标签: string[]; 提示: string; 拼音: string }>;
...
type 模版全局类型 = {
  设置: { 格式: string; 标签: string[]; 提示: string; 拼音: string };
  变量: { 格式: string; 标签: string[]; 提示: string; 拼音: string };
  子程序: { 格式: string; 标签: string[]; 提示: string; 拼音: string };
  全局规则: { 格式: string; 标签: string[]; 提示: string; 拼音: string };
  玩家规则: { 格式: string; 标签: string[]; 提示: string; 拼音: string };
  子程序规则: { 格式: string; 标签: string[]; 提示: string; 拼音: string };
};

type 模版规则类型 = {
  事件: { 格式: string; 标签: string[]; 提示: string; 拼音: string };
  条件: { 格式: string; 标签: string[]; 提示: string; 拼音: string };
  动作: { 格式: string; 标签: string[]; 提示: string; 拼音: string };
};
...
let 常量: 常量类型 = {
  按钮: [
    ...
    },
    {
      ...
      提示: "绑定主要攻击模式的按钮。",
      图标: {
        深色: "images/ow/input/left.png",
        浅色: "images/ow/input/left.png",
      },
    ...
    },
    {
      ...
      提示: "绑定辅助攻击模式的按钮。",
      图标: {
        深色: "images/ow/input/right.png",
        浅色: "images/ow/input/right.png",
      },
  ...
  英雄: [
    {
      ...
      标签: ["英雄", "支援"],
      提示:
        "作为守望先锋的副指挥官，安娜·艾玛莉利用她的技巧和专长保护家园和最亲密的人。",
    ...
    },
    {
      ...
      标签: ["英雄", "输出"],
      提示:
        "曾在智械危机中身为前线战斗单位，充满好奇心的“堡垒”现在成为了一名探险者，被自然之美深深吸引的同时也警惕着人性之恶。",
    ...
    },
    {
      ...
      标签: ["英雄", "重装"],
      提示:
        "D.Va曾经是一名职业玩家，而现在则利用自己的技巧驾驶一台尖端机甲保卫国家。",
    ...
    },
    {
      ...
      标签: ["英雄", "输出"],
      提示:
        "“回声”是守望先锋成员米娜·廖博士设计制造的机器人，搭载了可以高速学习适应的先进人工智能程序。",
    ...
    },
    {
      ...
      标签: ["英雄", "支援"],
      提示:
        "对那些在她照料下的人来说，“天使”是名副其实的守护天使：她是一位顶尖的治疗者、天才科学家以及坚定的和平使者。",
    ...
    },
    {
      ...
      标签: ["英雄", "重装"],
      提示:
        "奥丽莎是用一台在努巴尼昙花一现的 OR15 系列防御机器人的零件组装而成的。尽管她还有很多要学，但现在的奥丽莎已经成为了这座城市的守护者。",
    ...
    },
    {
      ...
      标签: ["英雄", "输出"],
      提示:
        "托比昂可以使用铆钉枪远距离或近距离作战，也可以布置一个炮台自动攻击敌人。他的锻造锤既可以修理炮台，也可以近身作战。他还可以射出高额伤害的熔岩陷阱持续伤害敌人。",
    ...
    },
    {
      ...
      标签: ["英雄", "输出"],
      提示:
        "前守望先锋成员“猎空”是一位可以进行时间跳跃的冒险家，为了正义而不懈努力着。",
    ...
    },
    {
      ...
      标签: ["英雄", "重装"],
      提示:
        "拉玛刹有过很多身份：士兵、僧侣、革命者。如今身为“归零者”领袖的他为智械而战，不惜一切代价。",
    ...
    },
    {
      ...
      标签: ["英雄", "支援"],
      提示:
        "生物光技术的杰出创造者，将植物物质和光结合在一起，他梦想着治愈世界。",
    ...
    },
    {
      ...
      标签: ["英雄", "重装"],
      提示:
        "骇灾是地下反叛界中一颗冉冉升起的新星，他是激进的破坏分子，是不可阻挡的武器，他的战斗要把秩序拆个粉碎。",
    ...
    },
    {
      ...
      标签: ["英雄", "输出"],
      提示:
        "弗蕾娅曾经是守望先锋搜救小队的一员，在守望先锋解散后，成为了赏金猎人。",
  ...
  等待行为: [
    ...
    },
    {
      ...
      标签: ["等待", "行为"],
      提示:
        "如果条件列表从假转变为真，或者规则中的事件在为真的条件下再次发生，则从第一项动作开始重新执行动作列表。",
...
let 规则: 规则类型 = {
  事件: {
    选项: [
      {
        ...
        标签: ["事件"],
        提示:
          "当比赛开始时，创建此规则的单一副本。此副本在整场比赛中保持激活状态。",
        拼音: "Chi Xu Quan Ju",
      },
      {
        名称: "持续 - 每名玩家",
        标签: ["事件"],
        提示:
          "当玩家加入比赛时，为每位玩家创建此规则的副本。此副本会保持激活，直至玩家离开比赛或比赛结束。每个副本都会独立追踪并执行条件和行动。",
    ...
    队伍: [
      ...
      },
      {
        ...
        标签: ["事件", "队伍"],
        提示:
          "表示两支队伍或非团队模式（例如“死斗”）的所有玩家。仅用于“规则事件”中的队伍选项。",
        拼音: "Shuang Fang",
      },
    ],
    玩家: [
  ...
  条件: {
    "If-Then-Else": {
      参数: [
        {
          ...
          默认: "真",
          提示:
            "如果此条件为真，则结果为Then后面的值。否则结果为Else后面的值。",
        },
        {
          名称: "Then",
          类型: "条件",
      ...
      标签: ["条件", "流程控制"],
      提示:
        "如果If后面的条件为真，则结果为Then后面的值。否则结果为Else后面的值。",
    },
    加: {
      参数: [
        {
      ...
      参数: [
        {
          ...
          默认: "真",
          提示:
            "如果输入为“假”（或等效于“假”），则“非”值为“真”。否则，则“非”值为“假”。",
        },
      ],
      格式: "!${1:0}",
      返回: ["布尔"],
      ...
      参数: [
        {
          ...
          默认: "真",
          提示:
            "考察的两个输入值中的一个。如果两个值均为“真”（或等效于“真”），则“与”的值为“真”。",
        },
        {
          名称: "值",
          类型: "条件",
      ...
      参数: [
        {
          ...
          默认: "真",
          提示:
            "考察的两个输入值中的一个。如果两个值中有一个为“真”（或等效于“真”），则“或”的值为“真”。",
        },
        {
          名称: "值",
          类型: "条件",
      ...
      参数: [
        {
          ...
          默认: "0",
          提示:
            "比较式的左边。如果操作为“==”或“!=”，则可以为任意类型的值。否则此值应为实数。",
        },
        {
          名称: "比较",
          类型: "比较",
        ...
        },
        {
          ...
          默认: "0",
          提示:
            "比较式的右边。如果操作为“==”或“!=”，则可以为任意类型的值。否则此值应为实数。",
        },
      ],
      格式: "${1:0} ${2:==} ${3:0}",
      返回: ["布尔"],
    ...
    上一个文本ID: {
      ...
      标签: ["条件", "ID"],
      提示:
        "代表由事件玩家创建的（或由全局创建的）通过“创建HUD文本”、“创建地图文本”、“创建进度条HUD文本”或“创建进度条地图文本”动作所创建的最后一段文本。",
    ...
    主机玩家: {
      ...
      标签: ["条件", "主机"],
      提示:
        "当前自定游戏的主机玩家。如果当前的主机玩家离开了比赛，该值会改变。",
      拼音: "Zhu Ji Wan Jia",
    },
    事件为急救包: {
      返回: ["布尔"],
    ...
    事件玩家: {
      ...
      标签: ["条件", "事件"],
      提示:
        "正在执行此规则的玩家，由事件指定。可能与攻击者或被攻击者为同一人。",
      拼音: "Shi Jian Wan Jia",
    },
    全局: {
      返回: ["全局"],
    ...
    占领要点模式正在得分的队伍: {
      ...
      标签: ["条件", "队伍"],
      提示:
        "该队伍正在占领要点模式中积累得分百分比。如果双方队伍都没有在积累得分，则结果为“全部”。",
    ...
    受治疗者: {
      ...
      标签: ["条件", "玩家"],
      提示:
        "根据此规则处理的事件中受到治疗的玩家。可能与治疗者或事件玩家是同一个人。",
    ...
    处于非初始状态: {
      ...
      标签: ["条件", "判断"],
      提示:
        "指定玩家当前是否处于非初始状态（如D.Va离开机甲、卢西奥使用加速音乐、堡垒处于转换形态期间、天使和托比昂使用辅助攻击武器，等等。）如果要检测回声是否正在使用人格复制，请使用“正在人格复制”的值。",
    ...
    实体数量: {
      ...
      标签: ["条件", "数量"],
      提示:
        "由“创建效果”、“创建光束效果”或“创建图标”动作创建的实体的当前数量。",
      拼音: "Shi Ti Shu Liang",
    },
    "对任意为“真”": {
      参数: [
        ...
        },
        {
          ...
          默认: "当前数组元素",
          提示:
            "对指定的数组中每个元素判断此条件。可以使用“当前数组元素”来指代数组中当前正在进行判断的元素。",
        },
      ],
      返回: ["布尔"],
      标签: ["条件", "数组"],
    ...
    对象索引: {
      ...
      标签: ["条件", "索引"],
      提示:
        "当前激活的控制点、运载目标检查点或运载目标目的地（0，1或2）。在攻防作战、攻击",
      ...
      参数: [
        {
          ...
          默认: "眼睛位置(事件玩家)",
          提示:
            "射线开始施放的位置。如果此处填入一名玩家，则使用从此玩家脚部向上2米的位置。",
        },
        {
          名称: "结束位置",
          类型: "条件",
    ...
    射线命中法线: {
      ...
      标签: ["条件", "射线"],
      提示:
        "射线命中平面的法线（如果没有命中，则从视线结束位置到射线起始位置）。",
    ...
    已排序的数组: {
      参数: [
        ...
        },
        {
          ...
          默认: "当前数组元素",
          提示:
            "将此值赋值给复制的数组中的每个元素。数组将以升序排列。可以使用“当前数组元素”来指代数组中当前正在进行判断的元素。",
        },
      ],
      返回: ["数组"],
      标签: ["条件", "数组"],
    ...
    已过滤的数组: {
      参数: [
        ...
        },
        {
          ...
          默认: "当前数组元素",
          提示:
            "对复制的数组中每个元素判断此条件。如果条件为“真”，则在复制的数组中保留此元素。可以使用“当前数组元素”来指代数组中当前正在进行判断的元素。",
        },
      ],
      返回: ["数组"],
      标签: ["条件", "数组"],
    ...
    攻击方: {
      ...
      标签: ["条件", "玩家"],
      提示:
        "根据此规则处理的事件中造成伤害的玩家。可能与被攻击者或事件玩家是同一个人。",
      拼音: "Gong Ji Fang",
    },
    数组: {
      参数: [
    ...
    文本数量: {
      ...
      标签: ["条件", "数量"],
      提示:
        "由“创建HUD文本”、“创建地图文本”、“创建进度条HUD文本”或“创建进度条地图文本”动作启动的文本副本的当前数量。",
    ...
    空: {
      ...
      标签: ["条件", "空"],
      提示:
        "一名玩家已离开。当没有玩家进行输入时使用。用来比较或测试时等效于实数0。",
      拼音: "Kong",
    },
    映射的数组: {
      参数: [
        ...
        },
        {
          ...
          默认: "当前数组元素",
          提示:
            "映射表达式将此数组中的每个元素复值为被复制的数组中的元素值。使用“当前数组元素”可以指定当前考察的数组中元素的值。",
        },
      ],
      返回: ["数组"],
      标签: ["条件", "数组"],
    ...
    最后创建的实体: {
      ...
      标签: ["条件", "ID"],
      提示:
        "对事件玩家创建的（或由全局创建的）最后一个效果，图标实体或机器人的引用。",
    ...
    服务器负载: {
      ...
      标签: ["条件", "百分比"],
      提示:
        "当前游戏副本造成的CPU负载百分比。如果这个数字接近或者超过100，表示此游戏副本消耗了过多资源，游戏很可能会关闭。",
      拼音: "Fu Wu Qi Fu Zai",
    },
    服务器负载峰值: {
      返回: ["数字"],
      标签: ["条件", "百分比"],
      提示:
        "当前游戏副本在过去2秒内造成的最高CPU负载百分比。如果这个数字接近或者超过100，表示此游戏副本消耗了过多资源，游戏很可能会关闭。",
      拼音: "Fu Wu Qi Fu Zai Feng Zhi",
    },
    服务器负载平均值: {
      返回: ["数字"],
      标签: ["条件", "百分比"],
      提示:
        "当前游戏副本在过去2秒内造成的平均CPU负载百分比。如果这个数字接近或者超过100，表示此游戏副本消耗了过多资源，游戏很可能会关闭。",
      拼音: "Fu Wu Qi Fu Zai Ping Jun Zhi",
    },
    本地玩家: {
      返回: ["实体"],
      标签: ["条件", "玩家"],
      提示:
        "由终端用户的电脑所操控的玩家。此值对每位终端用户均不相同，所以只有会影响视觉效果或HUD的动作才可访问此值。此值无法储存在变量中。（一般配合“持续 - 全局”规则使用。）",
      拼音: "Ben Di Wan Jia",
    },
    本地矢量: {
      参数: [
    ...
    标准化生命值: {
      ...
      标签: ["条件", "数学运算"],
      提示:
        "玩家当前的生命值，包括护甲和护盾，在0到1之间取标准化值。（例如，0为无生命值，0",
    ...
    栏位: {
      ...
      标签: ["条件", "栏位"],
      提示:
        "指定玩家的栏位编号。在队伍模式中，每个队伍中玩家的栏位编号为0到5的数字；在自由混战模式中，栏位编号为0到11。",
      拼音: "Lan Wei",
    },
    栏位数量: {
      参数: [
    ...
    正在人格复制: {
      ...
      标签: ["条件", "状态", "判断"],
      提示:
        "指定玩家是否正在复制另一名输出英雄。（为了检测复制的英雄，可使用“正在复制的英雄”的值。）",
      ...
      参数: [
        {
          ...
          默认: "0",
          提示:
            "获取指定栏位编号的玩家。在队伍模式中，每个队伍中玩家的栏位编号为0到5的数字；在自由混战模式中，栏位编号为0到11。",
        },
        {
          名称: "队伍",
          类型: "条件",
    ...
    水平朝向角度: {
      ...
      标签: ["条件", "角度"],
      提示:
        "玩家当前面对的方向与地图的水平夹角。当玩家转向左方时这个值会增加。（范围为",
    ...
    治疗者: {
      ...
      标签: ["条件", "玩家"],
      提示:
        "根据此规则处理的事件中造成治疗的玩家。可能与被治疗者或事件玩家是同一个人。",
      拼音: "Zhi Liao Zhe",
    },
    治疗调整数量: {
      返回: ["数字"],
    ...
    目标位置: {
      ...
      标签: ["条件", "位置"],
      提示:
        "特定目标点（控制点、运载目标检查点、或运载目标目的地）在地图中的位置。在攻防作战、攻击",
      拼音: "Mu Biao Wei Zhi",
    },
    目标是否完成: {
      参数: [
      ...
      标签: ["条件", "判断"],
      提示:
        "目标是否已经完成。如果游戏模式不是攻防作战、护送、或攻击/护送，则结果为“假”。在攻防作战、攻击/护送及占领要点模式中生效。",
    ...
    被攻击方: {
      ...
      标签: ["条件", "玩家"],
      提示:
        "根据此规则处理的事件中受到伤害的玩家。可能与攻击者或事件玩家是同一个人。",
      拼音: "Bei Gong Ji Fang",
    },
    视角中的玩家: {
      参数: [
    ...
    角度差: {
      ...
      标签: ["条件", "角度"],
      提示:
        "两个角度之间的度数差。将两个角度折算为彼此+/-180度范围内之后进行计算，如果第二个角度比第一个大则结果为正数。否则结果为负数。",
      拼音: "Jiao Du Cha",
    },
    角度的余弦值: {
      参数: [
    ...
    速率: {
      ...
      标签: ["条件", "矢量运算"],
      提示:
        "玩家当前的速率，此值为一个矢量。如果玩家位于表面上，则矢量在Y方向上的分量为0，即使在上坡或下坡。",
      拼音: "Su Lv",
    },
    重生点: {
      参数: [
    ...
    阈值: {
      ...
      标签: ["条件", "玩家"],
      提示:
        "玩家所输入的方向，通过一个矢量表示，X轴为水平（正值代表向左），Z轴为垂直（正值代表向前）。",
      拼音: "Yu Zhi",
    },
    随机实数: {
      参数: [
  ...
  动作: {
      ...
      参数: [
        {
          ...
          默认: "",
          提示:
            "如果此值为真，则继续执行下一个行动。否则，跳转至当前层级的下一个 Else If ，Else 或 End 行动并执行。",
        },
      ],
      标签: ["动作", "流程"],
      提示:
        "表示仅在指定条件为真，且前一个 If 或 Else If 的条件为假时，才会开始的一系列行动。",
    },
    End: {
      标签: ["动作", "流程"],
    ...
    "For 全局变量": {
      参数: [
        ...
        },
        {
          ...
          默认: "0",
          提示:
            "如果控制变量的值达到或超过此值，则退出循环，并跳转至 End 行动后的下一个行动继续执行。考察控制变量是否超过此值时，会根据步长值是正是负进行判断。如果控制变量在循环开始时已经达到或超过此值，则立即退出循环。",
        },
        {
          名称: "步长",
          类型: "条件",
          默认: "1",
          提示:
            "当达到 End 行动时，将此值加到控制变量上。如果此改动使控制变量达到或超过终止值，则退出循环，跳转执行 End 行动后的下一个行动。否则继续循环，并跳转至 For 行动后的下一个行动开始执行。",
        },
      ],
      标签: ["动作", "流程"],
      提示:
        "表示在循环中执行的一系列行动的开始，并在每次循环时修改控制变量的值。当前级别中的下一个End行动表示循环的结束。如果执行至循环顶部时，控制条件达到或超过终止值，则退出循环，跳至 End 操作之后的下一个操作执行。",
    ...
    While: {
      ...
      标签: ["动作", "流程"],
      提示:
        "表示只要指定的条件为真，就会在循环中执行的一系列行动的开始. 当前级别中的下一个 End 行动表示循环的结束. 如果执行至循环顶部时，条件评估为假，则退出循环，跳至 End 操作之后的下一个操作执行。",
    },
    中断: {
      标签: ["动作", "流程"],
      提示:
        "表示一个中止当前 While 或 For 循环的行动. 跳至 End 行动后的下一个行动继续执行。",
      拼音: "Zhong Duan",
    },
    中止: {
      标签: ["动作", "流程"],
    ...
    为玩家添加生命池: {
      ...
      标签: ["动作", "流程"],
      提示:
        "为一名或多名玩家添加临时的生命池。如果要指定此生命池，可以使用“最后创建的生命池”值。同一名玩家身上任意一个生命值类型（生命、护甲或护盾）的生命池最多可以存在16个（包括基本生命池和由技能获得的生命池）。",
    ...
    伤害: {
      参数: [
        ...
        },
        {
          ...
          默认: "事件玩家",
          提示:
            "伤害视为此名玩家造成的。如果“伤害者”设置为“空”则此伤害不会归到任何玩家名下。",
        },
        {
          名称: "伤害量",
          类型: "条件",
      ...
      参数: [
        {
          ...
          默认: "事件玩家",
          提示:
            "此玩家的变量将被修改。如果有多个玩家，则每个玩家的变量都将被设置。",
        },
        {
          名称: "变量",
          类型: "玩家变量",
    ...
    修改队伍分数: {
      ...
      标签: ["动作"],
      提示:
        "改变一方或双方队伍的分数。此动作在自由混战模式或没有队伍分数的模式中无效。",
      ...
      参数: [
        {
          ...
          默认: "上一个伤害调整ID",
          提示:
            "指定要结束的伤害调整副本。此ID可以是”上一个伤害调整ID“，或一个之前储存”上一个伤害调整ID“的变量。",
        },
      ],
      标签: ["动作"],
      ...
      参数: [
        {
          ...
          默认: "上一个助攻ID",
          提示:
            "指定要停止的助攻副本。此ID可以是“上一个助攻ID”，或一个之前储存“上一个助攻ID”的变量。",
        },
      ],
      标签: ["动作"],
      提示:
    ...
    停止强制玩家选择英雄: {
      ...
      标签: ["动作"],
      提示:
        "停止强制一名或多名玩家使用指定的英雄。此行动不会使玩家复生，只会在其下次选择英雄时恢复可用的其他英雄。",
    ...
    停止强制设置玩家位置: {
      ...
      标签: ["动作"],
      提示:
        "取消“开始强制设置玩家位置”行动对指定的一名或多名玩家造成的影响。这些玩家将从其最后被强制设置到的位置开始进行正常移动。",
      ...
      参数: [
        {
          ...
          默认: "上一个持续伤害效果ID",
          提示:
            "指定要结束的持续伤害副本。此ID可以是”上一个持续伤害效果ID“，或一个之前储存”上一个持续伤害效果ID“的变量。",
        },
      ],
      标签: ["动作"],
      ...
      参数: [
        {
          ...
          默认: "上一个持续治疗效果ID",
          提示:
            "指定要结束的持续治疗副本。此ID可以是”上一个持续治疗效果ID“，或一个之前储存”上一个持续治疗效果ID“的变量。",
        },
      ],
      标签: ["动作"],
      ...
      参数: [
        {
          ...
          默认: "上一个治疗调整ID",
          提示:
            "指定要结束的治疗调整副本。此ID可以是”上一个治疗调整ID“，或一个之前储存”上一个治疗调整ID“的变量。",
        },
      ],
      标签: ["动作"],
    ...
    击杀: {
      参数: [
        ...
        },
        {
          ...
          默认: "事件玩家",
          提示:
            "击杀视为此名玩家造成的。如果“击杀者”设置为“空”则此击杀不会归到任何玩家名下。",
        },
      ],
      标签: ["动作"],
      提示: "立即杀死一名或多名玩家。",
    ...
    创建HUD文本: {
      ...
      标签: ["动作"],
      提示:
        "在指定玩家屏幕上的指定位置创建一条HUD文本。此文本会持续至消除为止。如果想指定此文本，可使用“上一个文本ID”的返还值。如果已创建了太多的文本元素，此动作可能会失败。",
    ...
    创建光束效果: {
      参数: [
        ...
        },
        {
          ...
          默认: "颜色(白色)",
          提示:
            "所创建效果的颜色。如果选择了一支队伍，此效果将显示为红色或蓝色，根据观察者是否与这支队伍敌对决定。不会影响音效，只会影响“有益”或“有害”的光束效果。不支持自定义颜色。",
        },
        {
          名称: "重新赋值",
          类型: "效果刷新",
    ...
    创建图标: {
      ...
      标签: ["动作"],
      提示:
        "创建一个地图中的图标实体。此实体会持续至消除为止。如果想指定此实体，可使用“上一个创建的实体”的返还值。如果已创建了太多的实体，此动作可能会失败。",
    ...
    创建地图文本: {
      ...
      标签: ["动作"],
      提示:
        "在地图的指定位置创建一条地图文本，可以由指定玩家看到。此文本会持续至消除为止。如果想指定此文本，可使用“上一个文本ID”的返还值。如果已创建了太多的文本元素，此动作可能会失败。",
    ...
    创建效果: {
      参数: [
        ...
        },
        {
          ...
          默认: "颜色(白色)",
          提示:
            "所创建效果的颜色。如果选择了一支队伍，此效果将显示为红色或蓝色，根据观察者是否与这支队伍敌对决定。对声音效果无效。不支持自定义颜色。",
        },
        {
          名称: "位置",
          类型: "条件",
      ...
      标签: ["动作"],
      提示:
        "创建一个地图中的效果实体。此实体会持续至消除为止。如果想指定此实体，可使用“上一个创建的实体”的返还值。如果已创建了太多的实体，此动作可能会失败。",
    ...
    创建进度条HUD文本: {
      ...
      标签: ["动作"],
      提示:
        "在指定玩家屏幕上的指定位置创建一条进度条HUD文本。此文本会持续至消除为止。如果想指定此文本，可使用“上一个文本ID”的返还值。如果已创建了太多的文本元素，此动作可能会失败。",
    ...
    创建进度条地图文本: {
      ...
      标签: ["动作"],
      提示:
        "在地图的指定位置创建一条进度条HUD文本，可以由指定玩家看到。此文本会持续至消除为止。如果想指定此文本，可使用“上一个文本ID”的返还值。如果已创建了太多的文本元素，此动作可能会失败。",
    ...
    复生: {
      ...
      标签: ["动作"],
      提示:
        "使一名或多名玩家在适当的复生位置复生并恢复至最大生命值，对仍然存活的玩家依然有效。",
      拼音: "Fu Sheng",
    },
    大字体信息: {
      参数: [
    ...
    宣告玩家胜利: {
      ...
      标签: ["动作"],
      提示:
        "立即结束比赛并指定一名玩家为胜利者。此动作只在自由混战模式中生效。",
    ...
    开始助攻: {
      ...
      标签: ["动作"],
      提示:
        "当一名或多名目标被消灭时，开始将此助攻归于一名或多名助攻者名下。如果想指定此伤害调整，可以使用“上一个助攻ID“的值。如果已经开始了太多的助攻，此动作可能会失败。",
      拼音: "Kai Shi Zhu Gong",
    },
    开始定向阈值: {
      参数: [
    ...
    开始强制玩家选择英雄: {
      ...
      标签: ["动作"],
      提示:
        "开始强制一名或多名玩家使用指定的英雄，如有必要，使这些玩家立即在当前位置复生。这名或这些玩家只能使用指定的英雄，直到执行”停止强制玩家选择英雄“动作为止。",
    ...
    开始强制重生室: {
      ...
      标签: ["动作"],
      提示:
        "强制一支队伍在指定的重生室重生，不管在游戏模式中应当使用哪个重生室。此动作只会在攻防作战、攻击",
    ...
    开始持续伤害: {
      参数: [
        ...
        },
        {
          ...
          默认: "0",
          提示:
            "持续伤害的持续时间，以秒为单位。如果要让状态持续到被程序终止为止，可以输出较长的持续时间，如9999。",
        },
        {
          名称: "每秒伤害",
          类型: "条件",
      ...
      标签: ["动作"],
      提示:
        "开始一个持续伤害副本。此持续伤害会持续一段指定长度的时间，或直到被程序中止。如果想指定此持续伤害，可以使用”上一个持续伤害效果ID“的返还值。",
    ...
    开始持续治疗: {
      参数: [
        ...
        },
        {
          ...
          默认: "事件玩家",
          提示:
            "治疗视为此名玩家造成的。如果“治疗者”设置为“空”则此治疗不会归到任何玩家名下。",
        },
        {
          名称: "持续时间",
          类型: "条件",
          默认: "0",
          提示:
            "持续治疗的持续时间，以秒为单位。如果要让状态持续到被程序终止为止，可以输出较长的持续时间，如9999。",
        },
        {
          名称: "每秒治疗",
          类型: "条件",
      ...
      标签: ["动作"],
      提示:
        "开始一个持续治疗副本。此持续治疗会持续一段指定长度的时间，或直到被程序中止。如果想指定此持续治疗，可以使用”上一个持续治疗效果ID“的返还值。",
      ...
      参数: [
        {
          ...
          类型: "子程序",
          提示:
            "指定要开始的子程序。如果一个事件类型为子程序的规则指定了同一段子程序，那么它将会被执行。否则会忽略此行动。",
        },
        {
          名称: "是否正在执行",
          类型: "子程序行为",
    ...
    开始调整障碍大小: {
      参数: [
        ...
        },
        {
          ...
          默认: "1",
          提示:
            "此系数将作用于屏障的大小（0.5即为一半大小，2.0为大小加倍，诸如此类），此调整以“开始调整玩家大小”动作所设置的大小为基准。",
        },
        {
          名称: "重新赋值",
          类型: "条件",
    ...
    开始转换阈值: {
      参数: [
        ...
        },
        {
          ...
          默认: "0",
          提示:
            "下列玩家阈值的X轴（左右方向）将会乘以此数值，然后转换到新的相对方向。这个值会不断被重新赋值（每一帧都会更新）。",
        },
        {
          名称: "Y轴缩放",
          类型: "条件",
          默认: "0",
          提示:
            "下列玩家阈值的Y轴（前后方向）将会乘以此数值，然后转换到新的相对方向。这个值会不断被重新赋值（每一帧都会更新）。",
        },
        {
          名称: "相对方向",
          类型: "条件",
          默认: "矢量(0, 0, 0)",
          提示:
            "应用轴向缩放时，玩家的阈值将会被转换为相对此单位方向的矢量。例如，如果阈值转换至相对摄像机视角，则以摄像机的朝向为基准计算方向。这个值会不断被重新赋值（每一帧都会更新）并进行内部归一化。",
        },
      ],
      标签: ["动作"],
      提示:
    ...
    播放效果: {
      参数: [
        ...
        },
        {
          ...
          默认: "颜色(白色)",
          提示:
            "所创建效果的颜色。如果选择了一支队伍，此效果将显示为红色或蓝色，根据观察者是否与这支队伍敌对决定。不支持自定义颜色。",
        },
        {
          名称: "位置",
          类型: "条件",
    ...
    治疗: {
      参数: [
        ...
        },
        {
          ...
          默认: "事件玩家",
          提示:
            "治疗视为此名玩家造成的。如果“治疗者”设置为“无”则此治疗不会归到任何玩家名下。",
        },
        {
          名称: "治疗量",
          类型: "条件",
      ...
      参数: [
        {
          ...
          默认: "上一个文本ID",
          提示:
            "指定要消除的HUD文本。此ID可以是“上一个文本ID”，或一个之前储存“上一个文本ID”的变量。",
        },
      ],
      标签: ["动作"],
      ...
      参数: [
        {
          ...
          默认: "最后创建的实体",
          提示:
            "指定要消除的图标实体。可以是“最后创建的实体”，或一个之前储存“最后创建的实体”的变量。",
        },
      ],
      标签: ["动作"],
      ...
      参数: [
        {
          ...
          默认: "上一个文本ID",
          提示:
            "指定要消除的地图文本。此ID可以是“上一个文本ID”，或一个之前储存“上一个文本ID”的变量。",
        },
      ],
      标签: ["动作"],
      ...
      参数: [
        {
          ...
          默认: "上一个文本ID",
          提示:
            "指定要消除的进度条HUD文本。此ID可以是“上一个文本ID”，或一个之前储存“上一个文本ID”的变量。",
        },
      ],
      标签: ["动作"],
      ...
      参数: [
        {
          ...
          默认: "上一个文本ID",
          提示:
            "指定要消除的进度条地图文本。此ID可以是“上一个文本ID”，或一个之前储存“上一个文本ID”的变量。",
        },
      ],
      标签: ["动作"],
    ...
    生成机器人: {
      参数: [
        ...
        },
        {
          ...
          默认: "所有队伍",
          提示:
            "将机器人添加至此队伍。“全部”选项只适用于自由混战模式，“队伍”选项只适用于基于队伍的游戏模式。",
        },
        {
          名称: "栏位",
          类型: "条件",
          默认: "-1",
          提示:
            "在此玩家栏位添加机器人（-1表示第一个可用的空位）。不管游戏大厅中的设置如何，每支队伍最多可以加入6个机器人，自由混战队伍中最多可加入12个机器人。",
        },
        {
          名称: "位置",
          类型: "条件",
      ...
      参数: [
        {
          ...
          默认: "所有队伍",
          提示:
            "移除此队伍中的机器人。“全部”选项只适用于自由混战模式，“队伍”选项只适用于基于队伍的游戏模式。",
        },
        {
          名称: "栏位",
          类型: "条件",
      ...
      参数: [
        {
          ...
          默认: "最后创建的生命池",
          提示:
            "指定一个由“添加生命池”动作所创建的生命池。（可以用“最后创建的生命池”获得生命池ID的值。）",
        },
      ],
      标签: ["动作"],
    ...
    等待: {
      参数: [
        ...
        },
        {
          ...
          选项: 常量.等待行为,
          提示:
            "指定等待是否可以被中断。如果忽略条件列表，则等待不会被中断。否则则依据条件列表判断是否及何时中止或重新开始动作列表。",
        },
      ],
      标签: ["动作"],
      提示:
        "暂停执行动作列表。除非等待被中断，否则剩余的动作将在暂停之后执行。",
      拼音: "Deng Dai",
    },
    等待直到: {
      参数: [
    ...
    绑定玩家: {
      参数: [
        ...
        },
        {
          ...
          默认: "矢量(0, 0, 0)",
          提示:
            "子玩家与父玩家的相对坐标。例如，矢量 (1, 2, 0) 指示的是父玩家头顶左边的位置。",
        },
      ],
      标签: ["动作"],
      提示:
    ...
    设置主要攻击模式启用: {
      参数: [
        ...
        },
        {
          ...
          默认: "假",
          提示:
            "指定一名或多名玩家是否能够使用主要攻击模式。此处应为一个布尔，如“真”、“假”或“比较式”。",
        },
      ],
      标签: ["动作"],
    ...
    "设置启用技能 1": {
      参数: [
        ...
        },
        {
          ...
          默认: "假",
          提示:
            "玩家是否可以使用技能 1。此处应为一个布尔，如“真”、“假”或“比较式”。",
        },
      ],
      标签: ["动作"],
    ...
    "设置启用技能 2": {
      参数: [
        ...
        },
        {
          ...
          默认: "假",
          提示:
            "玩家是否可以使用技能 2。此处应为一个布尔，如“真”、“假”或“比较式”。",
        },
      ],
      标签: ["动作"],
    ...
    设置启用终极技能: {
      参数: [
        ...
        },
        {
          ...
          默认: "假",
          提示:
            "玩家是否可以使用终极技能。此处应为一个布尔，如“真”、“假”或“比较式”。",
        },
      ],
      标签: ["动作"],
    ...
    设置启用装填: {
      参数: [
        ...
        },
        {
          ...
          默认: "假",
          提示:
            "玩家是否可以使用装填。此处应为一个布尔，如“真”、“假”或“比较式”。",
        },
      ],
      标签: ["动作"],
      提示: "启用或禁用一名或多名玩家的装填。",
    ...
    设置启用跳跃: {
      参数: [
        ...
        },
        {
          ...
          默认: "假",
          提示:
            "玩家是否可以使用跳跃。此处应为一个布尔，如“真”、“假”或“比较式”。",
        },
      ],
      标签: ["动作"],
    ...
    设置启用蹲下: {
      参数: [
        ...
        },
        {
          ...
          默认: "假",
          提示:
            "玩家是否可以使用蹲下。此处应为一个布尔，如“真”、“假”或“比较式”。",
        },
      ],
      标签: ["动作"],
    ...
    设置启用近战攻击: {
      参数: [
        ...
        },
        {
          ...
          默认: "假",
          提示:
            "玩家是否可以使用近战攻击。此处应为一个布尔，如“真”、“假”或“比较式”。",
        },
      ],
      标签: ["动作"],
    ...
    创建弹道: {
      参数: [
        ...
        },
        {
          ...
          默认: "事件玩家",
          提示:
            "拥有此弹道且会被归为击杀者的玩家。若为“空”，则弹道不被任何人拥有。弹道不会影响其拥有者。",
        },
        {
          名称: "开始位置",
          类型: "条件",
        ...
        },
        {
          ...
          默认: "所有队伍",
          提示:
            "哪方队伍会被此弹道碰撞。不管弹道拥有者属于哪方队伍，弹道始终不会影响其拥有者。",
        },
        {
          名称: "数值",
          类型: "条件",
          默认: "0",
          提示:
            "对弹道碰撞目标造成的伤害或治疗量。如果“爆炸范围”设置为大于0，此数值表示爆炸对中心位置造成的伤害。",
        },
        {
          名称: "数值缩放",
          类型: "条件",
          默认: "0",
          提示:
            "如果“爆炸范围”设为0，此值表示暴击时伤害值的缩放量。如果“爆炸范围”大于0，此值表示弹道在爆炸边缘处造成的伤害值。",
        },
        {
          名称: "爆炸范围",
          类型: "条件",
        ...
        },
        {
          ...
          选项: 常量.弹道爆炸声音,
          提示:
            "弹道爆炸时应用的声音效果。如果“爆炸范围”为0，则不会创建此效果。",
        },
        {
          名称: "尺寸增幅",
          类型: "条件",
          默认: "0",
          提示:
            "此数值范围为0到1，表示该弹道尺寸增大的比例，0表示默认尺寸，1表示允许的最大尺寸。每种弹道类型的允许最大尺寸不同。",
        },
        {
          名称: "速度",
          类型: "条件",
        ...
        },
        {
          ...
          默认: "0",
          提示:
            "此弹道击中目标时施加的推力。如果“爆炸范围”大于0，此推力会施加给受爆炸影响的所有目标。",
        },
        {
          名称: "弹射次数",
          类型: "条件",
        ...
        },
        {
          ...
          默认: "0",
          提示:
            "影响此弹道的引力值，产生一道弧线。若为负值，则弹道会产生上抛弧线。",
        },
      ],
      标签: ["动作", "弹道"],
      提示:
        "创建一个弹道实体，可对玩家或玩家拥有的实体造成治疗或伤害。如果已创建了太多的实体，此动作可能会失败。",
    ...
    创建弹道效果: {
      ...
      标签: ["动作", "弹道", "效果"],
      提示:
        "创建一个地图中的弹道效果实体。此实体会持续至使用“消除效果”或“消除所有效果”消除为止。如果想引用此效果，可使用“上一个创建的实体”的返回值。如果已创建了太多的实体，此动作可能会失败。",
    ...
    创建追踪弹道: {
      参数: [
        ...
        },
        {
          ...
          默认: "0",
          提示:
            "此数值范围为0到1，表示该弹道追踪目标的强度，以及跟丢目标的难易度。0表示弹道完全不会追踪目标，1表示弹道会积极追踪目标且绝不会跟丢。",
        },
      ],
      标签: ["动作", "弹道", "追踪"],
      提示:
        "创建一个弹道实体，可对玩家或玩家拥有的实体造成治疗或伤害。弹道会按强度变量追踪给定目标。如果已创建了太多的实体，此动作可能会失败。",
    ...
    设置最大复生时间: {
      ...
      标签: ["动作"],
      提示:
        "设置一名或多名玩家死亡与复生之间的持续时间。对此动作执行时已经死亡的玩家，此效果将在他们下次死亡时生效。",
    ...
    设置状态: {
      参数: [
        ...
        },
        {
          ...
          默认: "事件玩家",
          提示:
            "如果在效果持续期间受到影响的玩家被击杀，则视为此名玩家完成的助攻。如果“助攻者”设置为“空”则此助攻不会归到任何玩家名下。",
        },
        {
          名称: "状态",
          类型: "状态",
        ...
        },
        {
          ...
          默认: "0",
          提示:
            "状态持续时间，以秒为单位。如果要让状态持续直到执行“清除状态”动作为止，可以输入较长的持续时间，如9999。",
        },
      ],
      标签: ["动作"],
      提示:
        "对一名或多名玩家施加一个状态。此状态会持续指定的”持续时间“，或直到被”清除状态“动作清除。",
    ...
    设置玩家可选的英雄: {
      ...
      标签: ["动作"],
      提示:
        "设置一名或多名玩家可用的英雄列表。如果玩家当前所使用的英雄变得不可用，则此玩家将被强制选择另一名英雄，并在适当的复生位置复生。",
    ...
    设置辅助攻击模式启用: {
      参数: [
        ...
        },
        {
          ...
          默认: "假",
          提示:
            "指定一名或多名玩家是否能够使用辅助攻击模式。此处应为一个布尔，如“真”、“假”或“比较式”。",
        },
      ],
      标签: ["动作"],
    ...
    设置队伍分数: {
      ...
      标签: ["动作"],
      提示:
        "设置一方或双方队伍的分数。此动作在自由混战模式或没有队伍分数的模式中无效。",
    ...
    调整玩家队伍: {
      参数: [
        ...
        },
        {
          ...
          默认: "所有队伍",
          提示:
            "将玩家移动至此队伍。“全部”选项只适用于自由混战模式，“队伍”选项只适用于基于队伍的游戏模式。",
        },
        {
          名称: "栏位",
          类型: "条件",
      ...
      参数: [
        {
          ...
          类型: "子程序",
          提示:
            "指定要调用的子程序。如果一个事件类型为子程序的规则指定了同一段子程序，那么它将会被执行。否则会忽略此行动。",
        },
      ],
      标签: ["动作"],
      提示:
    ...
    重置玩家英雄可选状态: {
      ...
      标签: ["动作"],
      提示:
        "将一名或多名玩家可用的英雄列表恢复至游戏设置所指定的英雄列表。如果玩家当前所使用的英雄变得不可用，则此玩家将被强制选择另一名英雄，并在适当的复生位置复生。",
