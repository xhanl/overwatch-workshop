    ...
    "对任意为“真”": {
      参数: [
        ...
        },
        {
          ...
          类型: "条件",
          默认: "当前数组元素",
          提示: "对指定的数组中每个元素判断此条件。可以使用“当前数组元素”来指代数组中当前正在进行判断的元素。",
        },
      ],
      返回: ["布尔"],
      标签: ["条件", "数组"],
    ...
    已排序的数组: {
      参数: [
        ...
        },
        {
          ...
          类型: "条件",
          默认: "当前数组元素",
          提示: "将此值赋值给复制的数组中的每个元素。数组将以升序排列。可以使用“当前数组元素”来指代数组中当前正在进行判断的元素。",
        },
      ],
      返回: ["数组"],
      标签: ["条件", "数组"],
    ...
    已过滤的数组: {
      参数: [
        ...
        },
        {
          ...
          类型: "条件",
          默认: "当前数组元素",
          提示: "对复制的数组中每个元素判断此条件。如果条件为“真”，则在复制的数组中保留此元素。可以使用“当前数组元素”来指代数组中当前正在进行判断的元素。",
        },
      ],
      返回: ["数组"],
      标签: ["条件", "数组"],
    ...
    映射的数组: {
      参数: [
        ...
        },
        {
          ...
          类型: "条件",
          默认: "当前数组元素",
          提示: "映射表达式将此数组中的每个元素复值为被复制的数组中的元素值。使用“当前数组元素”可以指定当前考察的数组中元素的值。",
        },
      ],
      返回: ["数组"],
      标签: ["条件", "数组"],
